      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-6 text-gray-300">
          <section>
            ...
            <p>Pusat Bantuan Pelanggan berkomitmen untuk melindungi privasi Anda. Kebijakan privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi Anda.</p>
          </section>
          ...
          <section>
            ...
            <p>Informasi yang Anda berikan akan digunakan secara eksklusif untuk keperluan dukungan pelanggan dan tidak akan dibagikan kepada pihak ketiga tanpa persetujuan Anda.</p>
          </section>
          ...
          <section>
            ...
            <p>Jika Anda memiliki pertanyaan mengenai kebijakan privasi ini, silakan hubungi kami melalui saluran dukungan yang tersedia di platform.</p>
          </section>
